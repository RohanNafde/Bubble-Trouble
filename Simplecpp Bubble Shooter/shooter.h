...
/* Shooter Vars */
const int SHOOTER_START_X = 480;
const int SHOOTER_START_Y = 475;
const int SHOOTER_VX = 500;
...
public:
    Shooter(double position_x, double position_y, double vx_=200, double height=32, double width=16, double head_radius=8, Color color_=COLOR(0, 255, 0))
    {
        // Shooter constructor
        color = color_;
    ...
    Bullet shoot(int level)
    {
        // shoot a bullet
        return Bullet(head.getX(), head.getY(),10,10,200*pow(1.25,level));
    }
